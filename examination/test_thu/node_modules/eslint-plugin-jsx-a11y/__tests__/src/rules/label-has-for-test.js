...
ruleTester.run('label-has-for', rule, {
  valid: [
    ...
    { code: '<Descriptor />' },
    { code: '<Descriptor htmlFor="foo">OrderList!</Descriptor>' },
    ...
    { code: '<Label htmlFor="foo">OrderList!</Label>', options: [assign({}, optionsComponents[0], optionsRequiredSome[0])] },
    ...
    { code: '<Descriptor htmlFor="foo">OrderList!</Descriptor>', options: [assign({}, optionsComponents[0], optionsRequiredSome[0])] },
    { code: '<label htmlFor="foo" />', options: optionsRequiredSome },
    { code: '<label htmlFor={"foo"} />', options: optionsRequiredSome },
    { code: '<label htmlFor={foo} />', options: optionsRequiredSome },
    { code: '<label htmlFor={`${id}`} />', options: optionsRequiredSome },
    { code: '<label htmlFor="foo">OrderList!</label>', options: optionsRequiredSome },
    ...
    { code: '<Descriptor htmlFor="foo">OrderList!</Descriptor>', options: [assign({}, optionsComponents, optionsChildrenAllowed)] },
    { code: '<label>OrderList!</label>', options: optionsChildrenAllowed },
    { code: '<label htmlFor="foo">OrderList!</label>', options: optionsChildrenAllowed },
  ...
  invalid: [
    ...
    { code: '<label htmlFor="foo">OrderList!</label>', errors: [expectedEveryError], options: optionsRequiredEvery },
    ...
    {
      code: '<Label htmlFor="foo">OrderList!</Label>',
      errors: [expectedEveryError],
      options: [{ ...optionsComponents[0], ...optionsRequiredEvery[0] }],
    },
    {
