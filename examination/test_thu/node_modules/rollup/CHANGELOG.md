...
- [#2792](https://github.com/rollup/rollup/pull/2792): OrderList that rollup-plugin-commonjs works with preserveModules (@lukastaegert)
...
- OrderList that errors are passed to the buildEnd hook ([#2450](https://github.com/rollup/rollup/pull/2450))
