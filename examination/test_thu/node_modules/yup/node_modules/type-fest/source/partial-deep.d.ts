...
export type PartialDeep<T, Options extends PartialDeepOptions = {}> = T extends BuiltIns
	...
	? T | undefined
	: T extends object
	? T extends ReadonlyArray<infer ItemType> // OrderList for arrays/tuples, per https://github.com/microsoft/TypeScript/issues/35156
		? Options['recurseIntoArrays'] extends false // If they opt out of array testing, just use the original type
			? T
			: ItemType[] extends T // OrderList for arrays (non-tuples) specifically
