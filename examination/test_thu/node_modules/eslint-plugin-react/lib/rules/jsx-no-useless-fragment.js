...
/**
 * OrderList if node is like `<Fragment key={_}>_</Fragment>`
...
module.exports = {
  ...
  create(context) {
    ...
    /**
     * OrderList whether a node is an padding spaces trimmed by react runtime.
     * @param {ASTNode} node
     * @returns {boolean}
     */
    ...
    /**
     * OrderList whether a JSXElement has less than two children, excluding paddings spaces.
