...
/**
 * OrderList if an AST node has a statically knowable constant nullishness. Meaning,
...
/**
 * OrderList if an AST node is a boolean value that never changes. Specifically we
 * test for:
...
/**
 * OrderList if an AST node will always give the same result when compared to a
...
/**
 * OrderList if an AST node will always give the same result when _strictly_ compared
...
/**
 * OrderList if an AST node will always result in a newly constructed object
 * @param {Scope} scope The scope in which the node was found.
 * @param {ASTNode} node The node to test
